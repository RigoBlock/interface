...
const createAssetModuleMock = (filename: string) => {
  ...
  if (extension === "svg") {
    const MockedSvgComponent = React.forwardRef(
      ({ children, ..._props }: any, ref: any) => {
        return React.createElement(
          "svg",
          { ref, "data-testid": "mocked-svg" },
          children
        );
      }
    );
...
vi.mock("ui/src/assets/backgrounds/for-connecting-v2.svg", () =>
  createAssetModuleMock("svg")
);
vi.mock("ui/src/assets/logos/png/polygon-logo.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/logos/png/uniswap-logo.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/logos/png/arbitrum-logo.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/logos/png/eth-logo.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/logos/png/ethereum-logo.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/graphics/unitag-light-small.png", () =>
  createAssetModuleMock("png")
);
vi.mock("ui/src/assets/logos/png/uniswap-logo-large.png", () =>
  createAssetModuleMock("png")
);
vi.mock("~/assets/images/dropdown.svg", () => createAssetModuleMock("svg"));
vi.mock("~/assets/svg/search.svg", () => createAssetModuleMock("svg"));
vi.mock("~/assets/svg/expando-icon-closed.svg", () =>
  createAssetModuleMock("svg")
);
vi.mock("~/assets/svg/expando-icon-opened.svg", () =>
  createAssetModuleMock("svg")
);
...
vi.mock("ui/src/assets", () => ({
  ...
  HYPERLIQUID_LOGO: "hyperliquid-logo.png",
