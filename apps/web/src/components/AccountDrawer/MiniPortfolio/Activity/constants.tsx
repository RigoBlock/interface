...
const getTransactionTitleTable = (): {
  ...
  [TransactionType.SubmitProposal]: {
    ...
    [TransactionStatus.Success]: i18n.t('Proposal submitted'),
    [TransactionStatus.Failed]: i18n.t('Proposal submission failed'),
  },
})
...
export const getCancelledTransactionTitleTable = (): { [key in TransactionType]: string } => ({
  ...
  [TransactionType.SetValue]: i18n.t('Set value canceled'),
  [TransactionType.Buy]: i18n.t('Buy canceled'),
  [TransactionType.Sell]: i18n.t('Sell canceled'),
  [TransactionType.Deploy]: i18n.t('Deploy canceled'),
  [TransactionType.Upgrade]: i18n.t('Upgrade canceled'),
  [TransactionType.Vote]: i18n.t('Vote canceled'),
  [TransactionType.Queue]: i18n.t('Queue canceled'),
  [TransactionType.Execute]: i18n.t('Execute canceled'),
  [TransactionType.Delegate]: i18n.t('Delegate canceled'),
  [TransactionType.SubmitProposal]: i18n.t('Proposal canceled'),
})
