interface Resources {
  "en-US": {
    ...
    "common.explorer.link": "View on Explorer",
    ...
    "common.searchSmartPools": "Search smart vaults",
    "common.searchTokensNFT": "Search tokens and NFT collections",
    "common.selectAction.label": "Select action",
    "common.selectRegion.label": "Select your region",
    "common.selectSmartPool.label": "Select a smart vault",
    ...
    "common.smartPools": "Smart vaults",
    "common.sold": "Sold",
    "common.stake": "Stake",
    "common.stats": "Stats",
    ...
    "common.transactionSuccess": "Transaction success",
    ...
    "notFound.oops": "Oops, take me back to base!",
    ...
    "pool.smartPoolPosition": "Smart vault positions",
    ...
    "privacy.autoRouter": "The app fetches the optimal trade route from a Rigoblock API.",
    ...
    "proposal.action.upgradeImplementation": "Proposed action: Upgrade Implementation",
    "proposal.action.addAdapter": "Proposed action: Add Adapter",
    "proposal.action.removeAdapter": "Proposed action: Remove Adapter",
    "proposal.action.upgradeStaking": "Proposed action: Upgrade Staking",
    "proposal.action.upgradeGovernance": "Proposed action: Upgrade Governance",
    ...
    "smartPools.selector.search.placeholder": "Search smart vaults",
    ...
    "vote.proposal.addAction": "Add action",
    ...
    "vote.votePage.onlyGrgVotesBeforeDateEligible": "Only GRG votes that became active before {{date}} are eligible for voting.",
